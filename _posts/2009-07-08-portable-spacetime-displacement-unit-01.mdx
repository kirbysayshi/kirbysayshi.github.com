...
export const meta = {
  ...
  tags: ["Flash", "AS3", "Temporal Displacement"],
  oneliner: "Perfect for when you need to change your, er... point of view, either spatially or temporally.",
  projecturl: "/flash/psdu01/",
  image: [
    { src: "/images/icons/psdu01.png", alt: "The Portable Spacetime Displacement Unit 01 icon, which is a tiny pocketwatch with it's internal gears exposed." },
  ],
};
