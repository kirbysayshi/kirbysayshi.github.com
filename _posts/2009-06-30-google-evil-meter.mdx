...
export const meta = {
  ...
  categories: ['web'],
  tags: ['Skynet', 'Twitter', 'PHP', 'MySQL', 'HTML5'],
  oneliner:
    "Powered by Twitter: Want to know when Google's going to channel Skynet? Keep track with the Google Evil Meter!",
  projecturl: 'https://johnnytatlock.com/gem',
  image: [{ src: '/images/icons/gem.png', alt: 'The Google Evil Meter logo.' }],
};
