...
p. PANDA is actually two components: 
  * A web framework for creating pages with different functionality easily and extensibly
  * Extra code that is only meant to be used internally at "ITA":http://ita.wisc.edu.
