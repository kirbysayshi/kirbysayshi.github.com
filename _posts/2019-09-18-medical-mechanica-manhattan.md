...
One of the movies I hosted was FLCL, which is actually a six episode experimental anime about growing up. I [removed the credits from each using `ffmpeg`](stuff/flcl-recut-cuts.sh), and cut down what would have been nearly three hours into two hours seventeen minutes!

And of course I had to have a drink, so I modified something to make it a little more special. Presenting, the "Spicy FLCL Manhattan", otherwise known as the "Medical Mechanica Manhattan".

```
Spicy FLCL Manhattan
