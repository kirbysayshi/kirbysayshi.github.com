...
<div data-role="figure">
	<img style={{ maxWidth: '100%' }} src="/images/identikitten-all-about-computer-love.png" alt="All About Computer Love" />
...
<div data-role="figure">
	<video loop autoPlay muted playsInline style={{ maxWidth: '100%' }} src="/images/zuzu.mp4" aria-label="A demonstration of the image melting effect using my kitty, Zuzu." />
...
<div data-role="figure">
	<img style={{ maxWidth: '100%' }} src="/images/image-melter-002.png" alt="Welcome to the Most Advanced Special Effect™ of 1993" />
...
<div data-role="figure">
	<img style={{ maxWidth: '100%' }} src="/images/alone-io.png" alt="Am I the last of humanity? YOU ARE ALONE." />
