...
export const meta = {
  title: 'Pristine',
  categories: ['flash'],
  tags: ['AS3', 'Papervision3D', 'BSG', 'Space', 'Flash'],
  oneliner:
    'A Flash-based, Papervision3D powered, space combat simulator in the vein of the X-Wing series with Battlestar Galactica mechanics.',
