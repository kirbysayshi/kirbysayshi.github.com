...
export const meta = {
  ...
  tags: ['AS3', 'GFSServer', 'Steampunk', 'Flex', 'Flash'],
  oneliner:
    "A stab at an online multiplayer game, based on chess. Throw in RPG elements, steampunk aesthetics, and a socket server, and you've almost got a game!",
  projecturl:
    'https://kirbysayshi.github.com/in-progress/2009/07/01/chess.html',
  image: [
    {
...
Flash-based _something_ that had a strong visual aspect. I decided it
